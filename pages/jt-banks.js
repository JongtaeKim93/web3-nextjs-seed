...
const JTBank = ({ privateKey, abi, contractAddress }) => {
...
JTBank.getInitialProps = async ({ pathname }) => {
	console.log('JTBank::getInitialProps', pathname);
	console.log('JTBank::getInitialProps::serverRuntimeConfig', serverRuntimeConfig);
